...
public class StringEx {
	...
	public static void main(String[] args) {
		...
		System.out.println(str1.equalsIgnoreCase(str2));	// 대소문자 구분없이 일치 여부 (t/f)
		...
		System.out.println(str1.substring(10));				// index앞의 문자열을 자르고, 뒤의 문자열 반환
		System.out.println(str1.substring(10, 17));			// index~(index2-1)까지 반환
															// Academy
															// [10]~[16]
		
		// split("구분자")		:(구분자)를 기준으로 문자열을 잘라서 배열로 반환
		String[] sp = str1.split("");	// (빈 문자열)""을 기준으로 하면, 한글자씩 배열요소로 반환
		...
		// String.split( 정규 표현식 )
		//	: 정규 표현식에서 + 기호는 산순연산자가 아닌 다른 의미로 사용
		// 산술연산자 + 로 구분하려면 앞에 \\ 기호를 붙여준다.
...
//		String cal = "10+20";
		...
		System.out.println("피연산자1 : " + num[1]);
