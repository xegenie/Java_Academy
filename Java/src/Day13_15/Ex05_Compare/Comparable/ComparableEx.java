...
class Book implements Comparable<Book> {
	...
	/*
	 * campareTo()
	 * - 해당 객체 this와 비교객체 o의 크기기준을 설정하여 반환메소드
	 * return
	 * 	양수(1)	: 해당객체 > 비교객체
	 * 	0		: 해당객체 = 비교객체
	 * 	음수(-1)	: 해당객체 < 비교객체
...
public class ComparableEx {
	...
	public static void main(String[] args) {
		...
		bookList.add(new Book("책1", "저자1", 30000));
		bookList.add(new Book("책2", "저자2", 60000));
		bookList.add(new Book("책3", "저자3", 20000));
		bookList.add(new Book("책4", "저자4", 10000));
		bookList.add(new Book("책5", "저자5", 80000));
		...
		// 정렬
		// * Book 클래스에서 구현한 compareTo() 메소드의 비교기준에 따라 정렬
