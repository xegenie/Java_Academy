...
public class StreamArrayList {
	...
	public static void main(String[] args) {
		...
		// * 이름순 - 오름차순
//		personList.stream().sorted( Comparator.comparing( p -> p.getName() ) )
//						   .forEach( p -> System.out.println(p) );
		// 메소드 레퍼런스 (::)
		// * 클래스명::메소드명
		...
		System.out.println();
		// * 이름순 - 내림차순 - .reversed()
		personList.stream().sorted( Comparator.comparing( Person::getName ).reversed() )
		.forEach( p -> System.out.println(p) );
		System.out.println();
		// * 나이순 - 내림차순
